...
CLIENT_APP_VERSION = os.getenv("CLIENT_APP_VERSION", "1.0.33").strip()
...
SLOW_SOURCE_FAIL_THRESHOLD = int(os.getenv("SLOW_SOURCE_FAIL_THRESHOLD", "2"))
SLOW_SOURCE_COOLDOWN_SECONDS = int(os.getenv("SLOW_SOURCE_COOLDOWN_SECONDS", "120"))
SLOW_SOURCE_TIMEOUT_SECONDS = float(os.getenv("SLOW_SOURCE_TIMEOUT_SECONDS", "1.2"))
