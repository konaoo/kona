<template>
  <LegacyAppShell>
    <div id="capture-area" class="kk-assets">
...
/* light 主题首页：按 kk 视觉风格重做（仅 /app/home 生效） */
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets {
  max-width: 1200px;
  margin: 0 auto;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .home-action-row {
  gap: 12px;
  margin-bottom: 14px;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .home-action-btn {
  width: 44px;
  height: 44px;
  border-radius: 999px;
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .home-action-btn:hover {
  transform: translateY(-2px);
  box-shadow: 0 24px 55px rgba(15, 23, 42, 0.14);
  background: rgba(255, 255, 255, 0.88);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .legacy-section {
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .legacy-section::before {
  content: '';
  position: absolute;
  inset: 0;
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .assets-header {
  gap: 22px;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .total-mv-label,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-total-label,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-label,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .pnl-label,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-pnl-label,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item-name,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .empty-state {
  color: rgba(15, 23, 42, 0.55);
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .main-mv {
  font-weight: 900;
  letter-spacing: -1px;
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-breakdown {
  gap: 12px;
  flex-wrap: wrap;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .pnl-stat-item,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-card,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item {
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card:hover,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .pnl-stat-item:hover,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-card:hover,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item:hover {
  transform: translateY(-2px);
  box-shadow: 0 24px 55px rgba(15, 23, 42, 0.14);
  border-color: rgba(99, 102, 241, 0.22);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .section-header {
  border-bottom: 1px solid rgba(15, 23, 42, 0.1);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .section-title {
  font-size: 20px;
  font-weight: 900;
  letter-spacing: -0.2px;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .goto-link {
  color: rgba(15, 23, 42, 0.55);
  font-size: 12px;
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .goto-link:hover {
  text-decoration: underline;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .section-add-btn {
  background: linear-gradient(135deg, #ff4d8d 0%, #6366f1 100%);
  box-shadow: 0 16px 40px rgba(99, 102, 241, 0.22);
  transition: transform 0.22s ease, box-shadow 0.22s ease;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .section-add-btn:hover {
  transform: translateY(-2px);
  box-shadow: 0 22px 55px rgba(99, 102, 241, 0.28);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-total-value {
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-total-value.cash {
  color: rgba(16, 185, 129, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-total-value.other {
  color: rgba(255, 77, 141, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-total-value.liability {
  color: rgba(239, 68, 68, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .pnl-value,
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .pnl-rate {
  font-weight: 900;
}

/* 保持金融语义：涨红跌绿 */
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .up {
  color: var(--legacy-red);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .down {
  color: var(--legacy-green);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-grid {
  gap: 10px;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-name {
  font-size: 16px;
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-mv {
  font-size: 22px;
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-mv.a {
  color: rgba(99, 102, 241, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-mv.us {
  color: rgba(168, 85, 247, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-mv.hk {
  color: rgba(255, 77, 141, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .category-mv.fund {
  color: rgba(16, 185, 129, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-grid {
  grid-template-columns: repeat(auto-fill, minmax(190px, 1fr));
  gap: 10px;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item-value {
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item-value.cash {
  color: rgba(16, 185, 129, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item-value.other {
  color: rgba(255, 77, 141, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .asset-card-item-value.liability {
  color: rgba(239, 68, 68, 0.95);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .action-btn {
  border: 1px solid rgba(15, 23, 42, 0.1);
  background: rgba(255, 255, 255, 0.8);
  color: rgba(15, 23, 42, 0.7);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .action-btn:hover {
  background: rgba(255, 255, 255, 0.95);
  color: rgba(15, 23, 42, 0.9);
  box-shadow: 0 14px 30px rgba(15, 23, 42, 0.1);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .overlay {
  background: rgba(15, 23, 42, 0.2);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .modal {
...
:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .modal-input {
  background: rgba(255, 255, 255, 0.9);
  border: 1px solid rgba(15, 23, 42, 0.1);
  color: rgba(15, 23, 42, 0.9);
}

:global(.legacy-page[data-theme='light']) #capture-area.kk-assets .modal-input:focus {
...
@media (max-width: 900px) {
  :global(.legacy-page[data-theme='light']) #capture-area.kk-assets .assets-header,
  :global(.legacy-page[data-theme='light']) #capture-area.kk-assets .invest-header {
    flex-direction: column;
  }
