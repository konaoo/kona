...
/* light 主题专属强化：只改视觉，不改数据口径 */
:global(.legacy-page[data-theme='light']) #capture-area .home-action-row {
  gap: 12px;
}

:global(.legacy-page[data-theme='light']) #capture-area .home-action-btn {
  width: 44px;
  height: 44px;
...
:global(.legacy-page[data-theme='light']) #capture-area .home-action-btn:hover {
  transform: translateY(-2px);
  box-shadow: 0 24px 55px rgba(15, 23, 42, 0.14);
  background: rgba(255, 255, 255, 0.88);
}

:global(.legacy-page[data-theme='light']) #capture-area .assets-header {
  gap: 22px;
}

:global(.legacy-page[data-theme='light']) #capture-area .total-mv-label,
:global(.legacy-page[data-theme='light']) #capture-area .invest-total-label,
:global(.legacy-page[data-theme='light']) #capture-area .asset-card-label,
:global(.legacy-page[data-theme='light']) #capture-area .pnl-label,
:global(.legacy-page[data-theme='light']) #capture-area .category-pnl-label,
:global(.legacy-page[data-theme='light']) #capture-area .asset-card-item-name,
:global(.legacy-page[data-theme='light']) #capture-area .input-label,
:global(.legacy-page[data-theme='light']) #capture-area .empty-state {
  color: rgba(15, 23, 42, 0.55);
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area .main-mv {
  background: linear-gradient(135deg, #ff4d8d 0%, #6366f1 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
}

:global(.legacy-page[data-theme='light']) #capture-area .section-header {
  border-bottom: 1px solid rgba(15, 23, 42, 0.1);
}

:global(.legacy-page[data-theme='light']) #capture-area .goto-link {
  color: rgba(15, 23, 42, 0.6);
  font-weight: 900;
}

:global(.legacy-page[data-theme='light']) #capture-area .section-add-btn {
  background: linear-gradient(135deg, #ff4d8d 0%, #6366f1 100%);
  box-shadow: 0 16px 40px rgba(99, 102, 241, 0.22);
  transition: transform 0.22s ease, box-shadow 0.22s ease;
}

:global(.legacy-page[data-theme='light']) #capture-area .section-add-btn:hover {
  transform: translateY(-2px);
  box-shadow: 0 22px 55px rgba(99, 102, 241, 0.28);
}

:global(.legacy-page[data-theme='light']) #capture-area .asset-card,
:global(.legacy-page[data-theme='light']) #capture-area .pnl-stat-item,
:global(.legacy-page[data-theme='light']) #capture-area .category-card,
:global(.legacy-page[data-theme='light']) #capture-area .asset-card-item {
...
:global(.legacy-page[data-theme='light']) #capture-area .asset-card:hover,
:global(.legacy-page[data-theme='light']) #capture-area .pnl-stat-item:hover,
:global(.legacy-page[data-theme='light']) #capture-area .category-card:hover,
:global(.legacy-page[data-theme='light']) #capture-area .asset-card-item:hover {
  transform: translateY(-2px);
  box-shadow: 0 24px 55px rgba(15, 23, 42, 0.14);
  border-color: rgba(99, 102, 241, 0.22);
}

:global(.legacy-page[data-theme='light']) #capture-area .action-btn {
  border: 1px solid rgba(15, 23, 42, 0.1);
...
:global(.legacy-page[data-theme='light']) #capture-area .action-btn:hover {
...
:global(.legacy-page[data-theme='light']) #capture-area .overlay {
  background: rgba(15, 23, 42, 0.2);
  backdrop-filter: blur(10px);
}

:global(.legacy-page[data-theme='light']) #capture-area .modal {
...
:global(.legacy-page[data-theme='light']) #capture-area .modal-input {
  background: rgba(255, 255, 255, 0.9);
  border: 1px solid rgba(15, 23, 42, 0.1);
  color: rgba(15, 23, 42, 0.9);
}

:global(.legacy-page[data-theme='light']) #capture-area .modal-input:focus {
