...
- `/Users/kona/Desktop/kaka/kona_repo/docs/分析页日历与分市场收益说明.md`
...
```bash
cd /opt/kaka/portfolio/kona_tool
.venv/bin/python scripts/backfill_day_pnl_from_total_delta.py \
...
```bash
cd /opt/kaka/portfolio/kona_tool
.venv/bin/python scripts/backfill_market_breakdown.py \
  --db-path /opt/kaka/portfolio/kona_tool/portfolio.db \
  --user-id <user_id> \
...
2. `/Users/kona/Desktop/kaka/kona_repo/docs/分析页日历与分市场收益说明.md`
3. `/Users/kona/Desktop/kaka/kona_repo/docs/资产同步与盈亏算法口径.md`（本文）
4. 再看代码：
   - `/Users/kona/Desktop/kaka/kona_repo/kona_tool/app.py`
   - `/Users/kona/Desktop/kaka/kona_repo/kona_tool/core/db.py`
   - `/Users/kona/Desktop/kaka/kona_repo/flutter/lib/providers/app_state.dart`
