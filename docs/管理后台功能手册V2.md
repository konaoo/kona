...
KONA_DATABASE_PATH=/opt/kaka/portfolio/kona_tool/portfolio.db .venv/bin/python migrations/009_add_user_force_password_change.py
KONA_DATABASE_PATH=/opt/kaka/portfolio/kona_tool/portfolio.db .venv/bin/python migrations/010_add_admin_api_policies.py
