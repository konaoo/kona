...
class _S {
  ...
  static final cardSub = GoogleFonts.dmSans(fontSize: 10, letterSpacing: 0.02);
...
class HomePageState extends State<HomePage> {
                      ...
                      child: Column(
                        children: [
                          ...
                          _buildCategoryCard(
                            ...
                            amount: _fmt(
                              appState.convertDisplayAmount(
                                appState.totalInvest,
                              ),
                              appState.amountHidden,
                            ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          GestureDetector(
            onTap: () =>
                widget.onSwitchTab(4), // Navigate to profile tab (index 4)
            child: Container(
              width: 34,
              height: 34,
              decoration: BoxDecoration(
            ...
            children: [
              ...
              LayoutBuilder(
                builder: (context, constraints) {
                  final displayTotal = appState.convertDisplayAmount(
                    appState.totalAsset,
                  );
                  return SizedBox(
          ...
          border: Border.all(
            color: AppTheme.isLight
                ...
                : AppTheme.gold.withValues(
                    alpha: _currDropdownOpen ? 0.4 : 0.26,
                  ),
          ),
          color: AppTheme.isLight
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isActive
                      ? AppTheme.gold.withValues(
                          alpha: AppTheme.isLight ? 0.08 : 0.14,
                        )
                      : Colors.transparent,
                  border: isLast
                      ? null
  ...
  Widget _heroIconBtn({required IconData icon, required VoidCallback onTap}) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        width: 30,
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: const LinearGradient(
                  ...
                  colors: [Color(0x235B8DEF), Color(0x0F4A7BE0)],
                ),
